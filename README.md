...
I used a free api version coming some limitations in which case I couldn't fetch data for more than a couple days, but the app can be easily upgraded if you have access to a key that allows that.  
